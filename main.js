...
const temporaryResultElement = document.querySelector('.temporary-result'); 
...
numbersElement.forEach( number => {
  number.addEventListener('click', (e)=>{
    ...
    displayTwoElement.innerText = dis2Num;
    // console.log();
  })
})
...
//Operation on Number Inputs
function clearVar(name = ''){
  dis1Num += dis2Num + ' ' + name + ' ';
  displayOneElement.innerText = dis1Num;
  displayTwoElement.innerText = '';
  dis2Num = '';
  temporaryResultElement.innerText = result;
}
...
equalElement.addEventListener('click', ()=> {
  ...
  temporaryResultElement.innerText = '';
  dis2Num = result;
  dis1Num = '';
})
